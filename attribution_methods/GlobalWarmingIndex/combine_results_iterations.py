...
for iteration in iterations:
    # TIMESERIES
    fname = f"{results_folder}/GWI_results_timeseries_{sample_size}_{iteration}.csv"
    skiprows = 0
    ...
    # HEADLINES
    fname = f"{results_folder}/GWI_results_headlines_{sample_size}_{iteration}.csv"
    skiprows = 0
...
df_ts_avg.to_csv(f'{results_folder}/GWI_results_timeseries_{sample_size}_AVERAGE.csv')
...
df_hl_avg.to_csv(f'{results_folder}/GWI_results_headlines_{sample_size}_AVERAGE.csv')
