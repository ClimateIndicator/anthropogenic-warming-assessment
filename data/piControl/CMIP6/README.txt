...
The source code required for all calculations is openly available at `<gitlab.com/netcdf-scm/netcdf-scm>`_ (netCDF-SCM releases are archived at `<https://doi.org/10.5281/zenodo.3903372>`_) and `<https://gitlab.com/netcdf-scm/calibration-data>`_.

Citation
========

If you use this data, please cite the publication below using your format of choice (further formats are available at https://doi.org/10.1002/gdj3.113).
...
@article{nicholls_gdj2020_cmipaggregate,
    ...
    url = {https://rmets.onlinelibrary.wiley.com/doi/abs/10.1002/gdj3.113},
    eprint = {https://rmets.onlinelibrary.wiley.com/doi/pdf/10.1002/gdj3.113},
    year = {2021}
}
